<template>
<div class="menu-lateral menu transition-smooth">
  <ul>
    <li>
      <button :class="this.classHamburguer" type="button">
...
.menu-animation ul li:first-child {
  padding-left: 0;
}
.menu-animation ul li {
...
.menu-lateral ul, .menu-animation ul {
  display: contents;
}

.menu-lateral ul li, .menu-animation ul li {
  display: flex;
...
.menu-lateral ul li img, .menu-animation ul li img {
  height: 25px;
}

.menu-lateral ul li:first-child, .menu-animation ul li:first-child {
  display: block;
  height: 30px;
  margin-top: 5px;
}

.menu-lateral ul li:nth-child(2), .menu-animation ul li:nth-child(2) {
  margin-top: 30px;
}
